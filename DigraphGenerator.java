...
public class DigraphGenerator {
   ...
   /**
     ...
     * is a DAG in which for every two vertices <tt>v != w<tt>, there is either
     * a directed edge from <tt>v</tt> to <tt>w</tt> or a directed edge
     * from <tt>w</tt> to <tt>v</tt>.
     * @param V the number of vertices
    ...
    /**
     * Returns a random rooted-out tree on <tt>V</tt> vertices.
     * The tree returned is not chosen uniformly at random among all such trees.
     * @param V the number of vertices
